...
" modified by fanweixiao 2012-05-17
" add CSS3, HTML5 support
...
" for HTML5
syn keyword cssTagName article aside canvas details figure figcaption 
syn keyword cssTagName header nav section summary time mark audio video
syn keyword cssTagName hgroup menu footer
" for flash
...
syn match cssBoxProp contained "\<border-\(\(\(top\|right\|bottom\|left\)-\)\=\(width\|radius\|color\|style\)\)\=\>"
...
syn match cssPseudoClassId contained "\<first\last\(-\(line\|letter\|child\)\)\=\>"
